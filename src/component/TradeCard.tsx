...
export default function TradingCard({tradeInfo, figureData}: any) {
    ...
    const itemMap = (itemlist: Array<number>, side: string) => itemlist.map((item: number, index: number) => 
        <div key={index} 
        ...
        <div className="trading-card-wrapper">
            <div className="trading-card">
                ...
                <div className="trading-items">
                    <div className="item-grid left box">
                        {itemMap(leftList, 'left')}
                    </div>
                    <div className="arrow">
                        <FontAwesomeIcon icon={faRightLong} />
                    </div>
                    <div className="item-grid right box">
                        {itemMap(rightList, 'right')}
                    </div>
                </div>
            </div>
        </div>
